javascript: (function() {
    ...
    function dyslexia() {
        ...
        function messUpWord(word) { if (word.length < 3) { return word } return word[0] + messUpMessyPart(word.slice(1, -1)) + word[word.length - 1] }
        ...
        function getRandomInt(min, max) { return Math.floor(Math.random() * (max - min + 1) + min) } setInterval(messUpWords, 50)
    }
})();